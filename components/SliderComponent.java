...
//        RenderUtility.drawRoundedRect(x + ClientFonts.sfuy.getWidth(name, 6) + 5,y,10,6, 1, ColorUtils.rgba(27, 27, 27, 255));
//        ClientFonts.sfuy.drawText(stack, String.valueOf(current),x + ClientFonts.sfuy.getWidth(name, 6) + 5 + 1f, y + 1f, -1,5);
