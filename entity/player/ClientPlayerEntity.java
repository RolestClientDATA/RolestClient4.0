...
import minecraft.rolest.command.interfaces.CommandDispatcher;
import minecraft.rolest.command.api.DispatchResult;
import minecraft.rolest.modules.api.ModuleManager;
import minecraft.rolest.modules.impl.misc.SelfDestruct;
import minecraft.rolest.modules.impl.misc.AntiPush;
...
public class ClientPlayerEntity extends AbstractClientPlayerEntity {
    ...
    public void tick() {
        if (this.world.isBlockLoaded(new BlockPos(this.getPosX(), 0.0D, this.getPosZ()))) {
            if (!Rol.getInstance().playerOnServer) {
                Rol.getInstance().playerOnServer = true;
            }

            Rol.getInstance().getEventBus().post(eventUpdate);
            super.tick();
    ...
    private void onUpdateWalkingPlayer() {
        ...
        Rol.getInstance().getEventBus().post(ea);
        ...
        if (this.isCurrentViewEntity()) {
            ...
            Rol.getInstance().getEventBus().post(eventMotion);
        ...
        Rol.getInstance().getEventBus().post(new EventPostMotion());
    ...
    public void sendChatMessage(String message) {
        ...
        CommandDispatcher commandDispatcher = Rol.getInstance().getCommandDispatcher();
    ...
    public void closeScreen() {
        ...
        Rol.getInstance().getEventBus().post(event);
        if (!event.isCancel()) {
    ...
    public void setSprinting(boolean sprinting) {
        Rol.getInstance().getEventBus().post(sprintEvent);
    ...
    public void livingTick() {
        ...
        if (this.isHandActive() && !this.isPassenger()) {
            Rol.getInstance().getEventBus().post(noSlowEvent);
    ...
    public boolean canAttackEntity(LivingEntity target, float v) {
        return false;
    }
