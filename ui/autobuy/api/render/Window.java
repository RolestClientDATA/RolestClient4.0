package minecraft.rolest.ui.autobuy.api.render;

import com.mojang.blaze3d.matrix.MatrixStack;
import com.mojang.blaze3d.platform.GlStateManager;

import minecraft.rolest.ui.autobuy.api.donate.DonateItems;
import minecraft.rolest.ui.autobuy.api.model.ItemStorage;
...
import minecraft.rolest.utils.animations.impl.DecelerateAnimation;
...
public class Window extends Screen implements IMinecraft {
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        // background
        RenderUtility.drawShadow(x, y, width, height, 10, ColorUtils.rgba(17, 17, 17, 128));
        RenderUtility.drawRoundedRect(x, y, width, height, 7, ColorUtils.rgba(17, 17, 17, 255));
    ...
    private void renderAddingPanel(MatrixStack matrixStack, float x, float y, float width, float height, int mouseX, int mouseY) {
        ...
        RenderUtility.drawShadow(x, y, width, height, 16, ColorUtils.rgba(28, 28, 28, (int) (255 * hoveredAnimation.getOutput())));
        RenderUtility.drawRoundedRect(x, y, width, height, 4,
                ColorUtils.rgba(23 + fade, 23 + fade, 23 + fade, 255));

        float fontHeight = Fonts.sfuy.getHeight(12);
        Fonts.sfuy.drawCenteredText(matrixStack, itemMenuOpened ? "Закрыть" : "Добавить предмет", x + (width / 2),
