package minecraft.rolest.ui.autobuy.api.logic;
...
public class AuctionLogic implements IMinecraft {
    ...
    int randomValue = ThreadLocalRandom.current().nextInt(500, 650);
    public void processAuctionSlot(ChestScreen chestScreen, Slot slot) {
        ...
        if (refreshStopWatch.isReached(455)) {
    ...
    int randomValue1 = ThreadLocalRandom.current().nextInt(1000, 1200);
    protected void buyItem(Container container, Slot slot, long currentTime) {
        if (currentTime - lastClickTime > 755 ) {
    ...
    protected void returnToAuction() {
        if (returnAuctionStopWatch.isReached(500)) {
