...
import minecraft.rolest.events.EventCancelOverlay;
import minecraft.rolest.modules.api.ModuleManager;
import minecraft.rolest.modules.impl.misc.NoServerDesync;
    ...
    public void handleEntityStatus(SEntityStatusPacket packetIn) {
        ...
        if (entity != null) {
            if (packetIn.getOpCode() == 21) {
                ...
                Rol.getInstance().getEventBus().post(eventCancelOverlay);
